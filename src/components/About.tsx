        ...
        <div className="about">
            ...
            <div className="faq">
                ...
                <span className="info" onClick={toggleInfo("delivery")}>
                    <p className={info.delivery ? "visible" : "hidden"}># Quel est le délai de rétractation ?  Le délai de rétraction est de XX jours, tu peux te rétracter à l'aide du lien que tu as reçu dans ton mail de confirmation de commande. Si ton colis n'a pas été expédié, nous annulerons l'envoit et tu recevras instantanément les dineros que tu nous a confié. Si ton colis a été expédié, nous attendrons que tu nous le renvois avant de te rendre la plata qui était tienne pour commencer.</p>
